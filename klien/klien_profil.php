...
<html lang="en">
<head>
  <title>Penjadwalan Konseling || Halaman Klien</title>
  <meta charset="utf-8">
    ...
    <div class="w3-col m3">
      ...
      <div class="w3-card-2 w3-round w3-white">
        <div class="w3-container">
         ...
         <hr>
         <p><i class="fa fa-pencil fa-fw w3-margin-right w3-text-theme"></i>Status (Klien)</p>
      ...
      <div class="w3-card-2 w3-round">
        ...
        <button onclick="myFunction('Demo3')" class="w3-btn-block w3-theme-l1 w3-left-align"><i class="fa fa-tags fa-fw w3-margin-right"></i>Penjadwalan</button>
          <div id="Demo3" class="w3-accordion-content w3-container">
			       <a href="klien_profil.php?url=penjadwalan"> Pilih Penjadwalan</a>
             <a href="klien_profil.php?url=history"> Riwayat Penjadwalan</a>
          </div>
