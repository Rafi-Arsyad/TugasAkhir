...
if(isset($_SESSION['konselor'])){
      ...
      <nav class="navbar navbar-default navbar-fixed-top">
        <div class="container-fluid">
          ...
          <div class="navbar-header">
            ...
            <a class="navbar-brand" href="home.php">Penjadwalan Konseling</a>
          </div>
  ...
  <li class="w3-hide-small"><a href="konselor/konselor_profil.php" class="w3-padding-large w3-hover-white" title="Terima Jadwal"><i class="fa fa-check"></i></a></li>
            ...
            <ul class="nav navbar-nav navbar-right">
              ...
              <a href="#" class="w3-padding-large w3-hover-white"><img src="assets/images/avatar.png" class="w3-circle" style="height:25px;width:25px" alt="Avatar">&nbsp;&nbsp;Hi, <?php echo $sql_sel['nama']; ?> &nbsp;<i class="fa fa-caret-down"></i></a>
                <div class="w3-dropdown-content w3-white w3-card-4">
                  <a href="konselor/konselor_profil.php"><i class="fa fa-user"></i>&nbsp;Accounts</a>
 ...
 <nav class="navbar navbar-default navbar-fixed-top">
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav">
              <li class="w3-hide-small"><a href="home.php" class="w3-padding-large w3-hover-white" title="Home"><i class="fa fa-home"></i></a></li>
  <li class="w3-hide-small"><a href="klien/klien_profil.php" class="w3-padding-large w3-hover-white" title="Tambah Jadwal"><i class="fa fa-plus"></i></a></li>
      ...
      <nav class="navbar navbar-fixed-top">
        <div class="container-fluid">
          ...
          <div class="navbar-header">
            ...
            <a class="navbar-brand" href="http://localhost/project/Home/index.php">
              <img src="assets/images/psikologi.png" alt="logo" style="width:35px">
            </a>
             <a class="navbar-brand" href="http://localhost/project/Home/index.php">
              <img src="assets/images/informatika.jpeg" alt="logo" style="width:35px">
            </a>
          </div>
          ...
          <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            ...
            <ul class="nav navbar-nav navbar-right">
              <!-- <li><a href="klien/klien_daftar.php">About Us</a></li> -->
            </ul>
          </div><!-- /.navbar-collapse -->
        </div><!-- /.container-fluid -->
      </nav>
