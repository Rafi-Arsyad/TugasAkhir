...
<html lang="en">
<head>
  <title>Penjadwalan Konseling || Halaman Konselor</title>
  <meta charset="utf-8">
...
<div class="container-fluid w3-content" style="max-width:1400px;margin-top:60px">
  ...
  <div class="w3-row">
    ...
    <div class="w3-col m3">
      ...
      <div class="w3-card-2 w3-round w3-white">
        <div class="w3-container">
         <br>
         <p class="w3-center"><img src="../assets/images/avatar.png" class="w3-circle" style="height:106px;width:106px" alt="Avatar"></p> <br>
         <h4 class="w3-center"><?php echo $sql_sel['nama']; ?></h4>
         <hr>
         <p><i class="fa fa-pencil fa-fw w3-margin-right w3-text-theme"></i>Status (Konselor)</p>
      ...
      <div class="w3-card-2 w3-round">
        ...
        <button onclick="myFunction('Demo3')" class="w3-btn-block w3-theme-l1 w3-left-align"><i class="fa fa-tags fa-fw w3-margin-right"></i>Penjadwalan</button>
          <div id="Demo3" class="w3-accordion-content w3-container">
			       <a href="konselor_profil.php?url=penjadwalan"> Terima Penjadwalan</a>
             <a href="konselor_profil.php?url=history"> Riwayat Penjadwalan</a>
             <a href="tambah_jadwal.php"> Tambah Penjadwalan</a>
          </div>
    ...
    <?php
    	if(isset($_GET['url'])){
        	if($_GET['url']=="penjadwalan"){
				include "terima_jadwal.php";
    ?>
      

      <?php
      		}elseif($_GET['url']=="history"){
				include "konselor_riwayat.php";
      ?>
      <?php
      }
      ?>
