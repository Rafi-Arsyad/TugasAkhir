        ...
        <hr class="w3-clear">
          <div class="w3-row-padding" style="margin:0 -16px">
            <div class="panel-heading">
                             Tabel Riwayat Penjadwalan Konseling Anda
                        </div>
                            ...
                            <div class="table-responsive">
                                <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                    ...
                                    <tbody>
                                     <?php
                                            $no = 1;
                                            $konselorName = $_SESSION['konselorname'];
                                     		$sql_sel = "select * from janji where psikolog = '$konselorName'";
                                              ...
                                              <tr>
                                                ...
                                                <td><?php echo $no++ ?></td>
                                                 ...
                                                 <td><?php echo $sql_res['jam_akhir']; ?></td>
                                                  <td>
                                                   <?php echo $sql_res['status'] == 1 && $sql_res['status_riwayat'] == 1 ? 'Selesai' : 'Belum Selesai'; ?>
                                                  </td>
