...
if(isset($_SESSION['konselor'])){
  ...
  <li class="w3-hide-small"><a href="konselor_profil.php" class="w3-padding-large w3-hover-white" title="Account Settings"><i class="fa fa-check"></i></a></li>
            ...
            <ul class="nav navbar-nav navbar-right">
              ...
              <a href="#" class="w3-padding-large w3-hover-white"><img src="../assets/images/avatar.png" class="w3-circle" style="height:25px;width:25px" alt="Avatar">&nbsp;&nbsp;Hi, <?php echo $sql_sel['nama']; ?> &nbsp;<i class="fa fa-caret-down"></i></a>
                <div class="w3-dropdown-content w3-white w3-card-4">
                  <a href="konselor_profil.php"><i class="fa fa-user"></i>&nbsp;Accounts</a>
 ...
 <nav class="navbar navbar-default navbar-fixed-top">
  ...
  <li class="w3-hide-small"><a href="konselor/konselor_profil.php" class="w3-padding-large w3-hover-white" title="Account Settings"><i class="fa fa-user"></i></a></li>
